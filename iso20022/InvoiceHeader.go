...
type InvoiceHeader2 struct {
	...
	// Party that issued this invoice document.
	Issuer *TradeParty3 `xml:"Issr,omitempty"`
...
func (i *InvoiceHeader2) SetIdentification(value string) {
	i.Identification = (*Max35Text)(&value)
}

func (i *InvoiceHeader2) SetTypeCode(value string) {
	i.TypeCode = (*ExternalDocumentType1Code)(&value)
}

func (i *InvoiceHeader2) AddName(value string) {
	i.Name = append(i.Name, (*Max35Text)(&value))
}

func (i *InvoiceHeader2) SetIssueDateTime(value string) {
	i.IssueDateTime = (*ISODateTime)(&value)
}

func (i *InvoiceHeader2) AddIssuer() *TradeParty3 {
	i.Issuer = new(TradeParty3)
	return i.Issuer
}

func (i *InvoiceHeader2) SetLanguageCode(value string) {
	i.LanguageCode = (*LanguageCode)(&value)
}

func (i *InvoiceHeader2) SetCopyIndicator(value string) {
	i.CopyIndicator = (*YesNoIndicator)(&value)
}

func (i *InvoiceHeader2) SetDocumentPurpose(value string) {
	i.DocumentPurpose = (*ExternalDocumentPurpose1Code)(&value)
}

func (i *InvoiceHeader2) AddIncludedNote() *AdditionalInformation6 {
	newValue := new(AdditionalInformation6)
	i.IncludedNote = append(i.IncludedNote, newValue)
	return newValue
}
