...
type BillingService1 struct {
	...
	ServiceDetail *BillingServiceParameters1 `xml:"SvcDtl"`
...
func (b *BillingService1) AddServiceDetail() *BillingServiceParameters1 {
	b.ServiceDetail = new(BillingServiceParameters1)
	return b.ServiceDetail
}

func (b *BillingService1) AddPrice() *BillingPrice1 {
	b.Price = new(BillingPrice1)
	return b.Price
}

func (b *BillingService1) SetPaymentMethod(value string) {
	b.PaymentMethod = (*ServicePaymentMethod1Code)(&value)
}

func (b *BillingService1) AddOriginalChargePrice() *AmountAndDirection34 {
	b.OriginalChargePrice = new(AmountAndDirection34)
	return b.OriginalChargePrice
}

func (b *BillingService1) AddOriginalChargeSettlementAmount() *AmountAndDirection34 {
	b.OriginalChargeSettlementAmount = new(AmountAndDirection34)
	return b.OriginalChargeSettlementAmount
}

func (b *BillingService1) AddBalanceRequiredAccountAmount() *AmountAndDirection34 {
	b.BalanceRequiredAccountAmount = new(AmountAndDirection34)
	return b.BalanceRequiredAccountAmount
}

func (b *BillingService1) AddTaxDesignation() *ServiceTaxDesignation1 {
	b.TaxDesignation = new(ServiceTaxDesignation1)
	return b.TaxDesignation
}

func (b *BillingService1) AddTaxCalculation() *BillingMethod1Choice {
