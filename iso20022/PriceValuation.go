...
func (p *PriceValuation3) SetIdentification(value string) {
	p.Identification = (*Max35Text)(&value)
}

func (p *PriceValuation3) AddValuationDateTime() *DateAndDateTimeChoice {
	p.ValuationDateTime = new(DateAndDateTimeChoice)
	return p.ValuationDateTime
}

func (p *PriceValuation3) AddNAVDateTime() *DateAndDateTimeChoice {
	p.NAVDateTime = new(DateAndDateTimeChoice)
	return p.NAVDateTime
}

func (p *PriceValuation3) AddFinancialInstrumentDetails() *FinancialInstrument8 {
	p.FinancialInstrumentDetails = new(FinancialInstrument8)
	return p.FinancialInstrumentDetails
}

func (p *PriceValuation3) AddFundManagementCompany() *PartyIdentification2Choice {
	p.FundManagementCompany = new(PartyIdentification2Choice)
	return p.FundManagementCompany
}

func (p *PriceValuation3) AddTotalNAV(value, currency string) {
	p.TotalNAV = append(p.TotalNAV, NewActiveOrHistoricCurrencyAndAmount(value, currency))
}

func (p *PriceValuation3) AddTotalUnitsNumber() *FinancialInstrumentQuantity1 {
	p.TotalUnitsNumber = new(FinancialInstrumentQuantity1)
	return p.TotalUnitsNumber
}

func (p *PriceValuation3) AddNextValuationDateTime() *DateAndDateTimeChoice {
	p.NextValuationDateTime = new(DateAndDateTimeChoice)
	return p.NextValuationDateTime
}

func (p *PriceValuation3) AddPreviousValuationDateTime() *DateAndDateTimeChoice {
	p.PreviousValuationDateTime = new(DateAndDateTimeChoice)
	return p.PreviousValuationDateTime
}

func (p *PriceValuation3) SetValuationType(value string) {
	p.ValuationType = (*ValuationTiming1Code)(&value)
}

func (p *PriceValuation3) SetValuationFrequency(value string) {
	p.ValuationFrequency = (*EventFrequency1Code)(&value)
}

func (p *PriceValuation3) SetOfficialValuationIndicator(value string) {
	p.OfficialValuationIndicator = (*YesNoIndicator)(&value)
}

func (p *PriceValuation3) SetSuspendedIndicator(value string) {
	p.SuspendedIndicator = (*YesNoIndicator)(&value)
}

func (p *PriceValuation3) AddPriceDetails() *UnitPrice15 {
	newValue := new(UnitPrice15)
	p.PriceDetails = append(p.PriceDetails, newValue)
	return newValue
}

func (p *PriceValuation3) AddValuationStatistics() *ValuationStatistics3 {
	newValue := new(ValuationStatistics3)
	p.ValuationStatistics = append(p.ValuationStatistics, newValue)
	return newValue
}

func (p *PriceValuation3) AddPerformanceDetails() *PerformanceFactors1 {
