...
type Baseline5 struct {
	...
	// Specifies that another type of certificate data set is required for each shipment part of the transaction.
	OtherCertificateDataSetRequired []*RequiredSubmission6 `xml:"OthrCertDataSetReqrd,omitempty"`

	// Specifies that IntentToPayNotice message(s) are expected as part of this transaction.
	IntentToPayExpected *YesNoIndicator `xml:"InttToPayXpctd"`
}

func (b *Baseline5) AddSubmitterBaselineIdentification() *DocumentIdentification1 {
	b.SubmitterBaselineIdentification = new(DocumentIdentification1)
	return b.SubmitterBaselineIdentification
}

func (b *Baseline5) SetServiceCode(value string) {
	b.ServiceCode = (*TradeFinanceService2Code)(&value)
}

func (b *Baseline5) AddPurchaseOrderReference() *DocumentIdentification7 {
	b.PurchaseOrderReference = new(DocumentIdentification7)
	return b.PurchaseOrderReference
}

func (b *Baseline5) AddBuyer() *PartyIdentification26 {
	b.Buyer = new(PartyIdentification26)
	return b.Buyer
}

func (b *Baseline5) AddSeller() *PartyIdentification26 {
	b.Seller = new(PartyIdentification26)
	return b.Seller
}

func (b *Baseline5) AddBuyerBank() *BICIdentification1 {
	b.BuyerBank = new(BICIdentification1)
	return b.BuyerBank
}

func (b *Baseline5) AddSellerBank() *BICIdentification1 {
	b.SellerBank = new(BICIdentification1)
	return b.SellerBank
}

func (b *Baseline5) AddBuyerSideSubmittingBank() *BICIdentification1 {
	newValue := new(BICIdentification1)
	b.BuyerSideSubmittingBank = append(b.BuyerSideSubmittingBank, newValue)
	return newValue
}

func (b *Baseline5) AddSellerSideSubmittingBank() *BICIdentification1 {
	newValue := new(BICIdentification1)
	b.SellerSideSubmittingBank = append(b.SellerSideSubmittingBank, newValue)
	return newValue
}

func (b *Baseline5) AddBillTo() *PartyIdentification26 {
	b.BillTo = new(PartyIdentification26)
	return b.BillTo
}

func (b *Baseline5) AddShipTo() *PartyIdentification26 {
	b.ShipTo = new(PartyIdentification26)
	return b.ShipTo
}

func (b *Baseline5) AddConsignee() *PartyIdentification26 {
	b.Consignee = new(PartyIdentification26)
	return b.Consignee
}

func (b *Baseline5) AddGoods() *LineItem13 {
	b.Goods = new(LineItem13)
	return b.Goods
}

func (b *Baseline5) AddPaymentTerms() *PaymentTerms5 {
	newValue := new(PaymentTerms5)
	b.PaymentTerms = append(b.PaymentTerms, newValue)
	return newValue
}

func (b *Baseline5) AddSettlementTerms() *SettlementTerms3 {
	b.SettlementTerms = new(SettlementTerms3)
	return b.SettlementTerms
}

func (b *Baseline5) AddPaymentObligation() *PaymentObligation2 {
	newValue := new(PaymentObligation2)
	b.PaymentObligation = append(b.PaymentObligation, newValue)
	return newValue
}

func (b *Baseline5) SetLatestMatchDate(value string) {
	b.LatestMatchDate = (*ISODate)(&value)
}

func (b *Baseline5) AddCommercialDataSetRequired() *RequiredSubmission2 {
	b.CommercialDataSetRequired = new(RequiredSubmission2)
	return b.CommercialDataSetRequired
}

func (b *Baseline5) AddTransportDataSetRequired() *RequiredSubmission2 {
	b.TransportDataSetRequired = new(RequiredSubmission2)
	return b.TransportDataSetRequired
}

func (b *Baseline5) AddInsuranceDataSetRequired() *RequiredSubmission3 {
	b.InsuranceDataSetRequired = new(RequiredSubmission3)
	return b.InsuranceDataSetRequired
}

func (b *Baseline5) AddCertificateDataSetRequired() *RequiredSubmission4 {
	newValue := new(RequiredSubmission4)
	b.CertificateDataSetRequired = append(b.CertificateDataSetRequired, newValue)
	return newValue
}

func (b *Baseline5) AddOtherCertificateDataSetRequired() *RequiredSubmission6 {
	newValue := new(RequiredSubmission6)
	b.OtherCertificateDataSetRequired = append(b.OtherCertificateDataSetRequired, newValue)
	return newValue
}

func (b *Baseline5) SetIntentToPayExpected(value string) {
	b.IntentToPayExpected = (*YesNoIndicator)(&value)
}
