...
func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification19 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddConfirmationReference() *iso20022.Identification14 {
	s.ConfirmationReference = new(iso20022.Identification14)
	return s.ConfirmationReference
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddAdditionalParameters() *iso20022.AdditionalParameters30 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters30)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddTradeDetails() *iso20022.SecuritiesTradeDetails53 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount41 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount41)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddSettlementParameters() *iso20022.SettlementDetails128 {
	s.SettlementParameters = new(iso20022.SettlementDetails128)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddStandingSettlementInstructionDetails() *iso20022.StandingSettlementInstruction11 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddDeliveringSettlementParties() *iso20022.SettlementParties36 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddCashParties() *iso20022.CashParties25 {
	s.CashParties = new(iso20022.CashParties25)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddSettledAmount() *iso20022.AmountAndDirection46 {
	s.SettledAmount = new(iso20022.AmountAndDirection46)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddOtherAmounts() *iso20022.OtherAmounts30 {
	s.OtherAmounts = new(iso20022.OtherAmounts30)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddOtherBusinessParties() *iso20022.OtherParties27 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
