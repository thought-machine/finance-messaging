...
func (s *SecuritiesFinancingInstructionV07) AddTransactionTypeAndAdditionalParameters() *iso20022.TransactionTypeAndAdditionalParameters15 {
	s.TransactionTypeAndAdditionalParameters = new(iso20022.TransactionTypeAndAdditionalParameters15)
	return s.TransactionTypeAndAdditionalParameters
}

func (s *SecuritiesFinancingInstructionV07) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesFinancingInstructionV07) AddLinkages() *iso20022.Linkages37 {
	newValue := new(iso20022.Linkages37)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesFinancingInstructionV07) AddTradeDetails() *iso20022.SecuritiesTradeDetails56 {
...
func (s *SecuritiesFinancingInstructionV07) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails28 {
...
func (s *SecuritiesFinancingInstructionV07) AddCashParties() *iso20022.CashParties26 {
...
func (s *SecuritiesFinancingInstructionV07) AddOtherAmounts() *iso20022.OtherAmounts28 {
...
func (s *SecuritiesFinancingInstructionV07) AddSupplementaryData() *iso20022.SupplementaryData1 {
