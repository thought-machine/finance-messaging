...
func (s *SecuritiesFinancingConfirmation002V07) AddTransactionIdentificationDetails() *iso20022.TransactionTypeAndAdditionalParameters19 {
	s.TransactionIdentificationDetails = new(iso20022.TransactionTypeAndAdditionalParameters19)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesFinancingConfirmation002V07) AddAdditionalParameters() *iso20022.AdditionalParameters26 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters26)
	return s.AdditionalParameters
}

func (s *SecuritiesFinancingConfirmation002V07) AddTradeDetails() *iso20022.SecuritiesTradeDetails58 {
...
func (s *SecuritiesFinancingConfirmation002V07) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
...
func (s *SecuritiesFinancingConfirmation002V07) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount62 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount62)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingConfirmation002V07) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails30 {
...
func (s *SecuritiesFinancingConfirmation002V07) AddSettlementParameters() *iso20022.SettlementDetails104 {
...
func (s *SecuritiesFinancingConfirmation002V07) AddCashParties() *iso20022.CashParties30 {
	s.CashParties = new(iso20022.CashParties30)
	return s.CashParties
}

func (s *SecuritiesFinancingConfirmation002V07) AddSettledAmount() *iso20022.AmountAndDirection60 {
	s.SettledAmount = new(iso20022.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesFinancingConfirmation002V07) AddOtherAmounts() *iso20022.OtherAmounts34 {
...
func (s *SecuritiesFinancingConfirmation002V07) AddSupplementaryData() *iso20022.SupplementaryData1 {
