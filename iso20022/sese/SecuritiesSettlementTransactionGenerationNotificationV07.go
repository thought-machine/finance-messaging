...
func (d *Document03200107) AddMessage() *SecuritiesSettlementTransactionGenerationNotificationV07 {
	d.Message = new(SecuritiesSettlementTransactionGenerationNotificationV07)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification19 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddLinkages() *iso20022.Linkages37 {
	newValue := new(iso20022.Linkages37)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddTradeDetails() *iso20022.SecuritiesTradeDetails67 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails67)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount39 {
	newValue := new(iso20022.QuantityAndAccount39)
	s.QuantityAndAccountDetails = append(s.QuantityAndAccountDetails, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSettlementParameters() *iso20022.SettlementDetails120 {
	s.SettlementParameters = new(iso20022.SettlementDetails120)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddDeliveringSettlementParties() *iso20022.SettlementParties36 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddCashParties() *iso20022.CashParties26 {
	s.CashParties = new(iso20022.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSettlementAmount() *iso20022.AmountAndDirection46 {
	s.SettlementAmount = new(iso20022.AmountAndDirection46)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddOtherAmounts() *iso20022.OtherAmounts28 {
	s.OtherAmounts = new(iso20022.OtherAmounts28)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddOtherBusinessParties() *iso20022.OtherParties27 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddGeneratedReason() *iso20022.GeneratedReason5 {
	newValue := new(iso20022.GeneratedReason5)
	s.GeneratedReason = append(s.GeneratedReason, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddStatusAndReason() *iso20022.StatusAndReason28 {
	s.StatusAndReason = new(iso20022.StatusAndReason28)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV07) AddSupplementaryData() *iso20022.SupplementaryData1 {
