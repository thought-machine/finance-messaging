...
func (d *Document02400108) AddMessage() *SecuritiesSettlementTransactionStatusAdviceV08 {
	d.Message = new(SecuritiesSettlementTransactionStatusAdviceV08)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddTransactionIdentification() *iso20022.TransactionIdentifications31 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications31)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddLinkages() *iso20022.Linkages41 {
	s.Linkages = new(iso20022.Linkages41)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddProcessingStatus() *iso20022.ProcessingStatus48Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus48Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddInferredMatchingStatus() *iso20022.MatchingStatus24Choice {
	s.InferredMatchingStatus = new(iso20022.MatchingStatus24Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddMatchingStatus() *iso20022.MatchingStatus24Choice {
	s.MatchingStatus = new(iso20022.MatchingStatus24Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddSettlementStatus() *iso20022.SettlementStatus17Choice {
	s.SettlementStatus = new(iso20022.SettlementStatus17Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddTransactionDetails() *iso20022.TransactionDetails97 {
	s.TransactionDetails = new(iso20022.TransactionDetails97)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV08) AddSupplementaryData() *iso20022.SupplementaryData1 {
