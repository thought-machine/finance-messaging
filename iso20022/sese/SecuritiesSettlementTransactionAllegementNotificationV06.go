...
func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters12 {
...
func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddTradeDetails() *iso20022.SecuritiesTradeDetails54 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails54)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification19 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification19)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount42 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount42)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails29 {
	s.SecuritiesFinancingDetails = new(iso20022.SecuritiesFinancingTransactionDetails29)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddSettlementParameters() *iso20022.SettlementDetails125 {
	s.SettlementParameters = new(iso20022.SettlementDetails125)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddDeliveringSettlementParties() *iso20022.SettlementParties36 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddCashParties() *iso20022.CashParties25 {
	s.CashParties = new(iso20022.CashParties25)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddSettlementAmount() *iso20022.AmountAndDirection48 {
	s.SettlementAmount = new(iso20022.AmountAndDirection48)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddOtherAmounts() *iso20022.OtherAmounts32 {
	s.OtherAmounts = new(iso20022.OtherAmounts32)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddOtherBusinessParties() *iso20022.OtherParties28 {
	s.OtherBusinessParties = new(iso20022.OtherParties28)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
