...
func (d *Document02800206) AddMessage() *SecuritiesSettlementTransactionAllegementNotification002V06 {
	d.Message = new(SecuritiesSettlementTransactionAllegementNotification002V06)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters15 {
...
func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails60 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails60)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount58 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount58)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails34 {
	s.SecuritiesFinancingDetails = new(iso20022.SecuritiesFinancingTransactionDetails34)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementParameters() *iso20022.SettlementDetails131 {
	s.SettlementParameters = new(iso20022.SettlementDetails131)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddCashParties() *iso20022.CashParties32 {
	s.CashParties = new(iso20022.CashParties32)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSettlementAmount() *iso20022.AmountAndDirection71 {
	s.SettlementAmount = new(iso20022.AmountAndDirection71)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddOtherAmounts() *iso20022.OtherAmounts36 {
	s.OtherAmounts = new(iso20022.OtherAmounts36)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddOtherBusinessParties() *iso20022.OtherParties31 {
	s.OtherBusinessParties = new(iso20022.OtherParties31)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionAllegementNotification002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
