...
func (s *SecuritiesFinancingConfirmationV07) AddTransactionIdentificationDetails() *iso20022.TransactionTypeAndAdditionalParameters16 {
	s.TransactionIdentificationDetails = new(iso20022.TransactionTypeAndAdditionalParameters16)
	return s.TransactionIdentificationDetails
}

func (s *SecuritiesFinancingConfirmationV07) AddAdditionalParameters() *iso20022.AdditionalParameters24 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters24)
	return s.AdditionalParameters
}

func (s *SecuritiesFinancingConfirmationV07) AddTradeDetails() *iso20022.SecuritiesTradeDetails55 {
...
func (s *SecuritiesFinancingConfirmationV07) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails28 {
...
func (s *SecuritiesFinancingConfirmationV07) AddCashParties() *iso20022.CashParties26 {
	s.CashParties = new(iso20022.CashParties26)
	return s.CashParties
}

func (s *SecuritiesFinancingConfirmationV07) AddSettledAmount() *iso20022.AmountAndDirection46 {
	s.SettledAmount = new(iso20022.AmountAndDirection46)
	return s.SettledAmount
}

func (s *SecuritiesFinancingConfirmationV07) AddOtherAmounts() *iso20022.OtherAmounts31 {
...
func (s *SecuritiesFinancingConfirmationV07) AddSupplementaryData() *iso20022.SupplementaryData1 {
