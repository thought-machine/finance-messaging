...
func (s *SecuritiesSettlementTransactionInstructionV07) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters19 {
	s.SettlementTypeAndAdditionalParameters = new(iso20022.SettlementTypeAndAdditionalParameters19)
	return s.SettlementTypeAndAdditionalParameters
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddLinkages() *iso20022.Linkages37 {
	newValue := new(iso20022.Linkages37)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddTradeDetails() *iso20022.SecuritiesTradeDetails51 {
...
func (s *SecuritiesSettlementTransactionInstructionV07) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount39 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount39)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddSettlementParameters() *iso20022.SettlementDetails119 {
	s.SettlementParameters = new(iso20022.SettlementDetails119)
...
func (s *SecuritiesSettlementTransactionInstructionV07) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddCashParties() *iso20022.CashParties26 {
	s.CashParties = new(iso20022.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddSettlementAmount() *iso20022.AmountAndDirection46 {
	s.SettlementAmount = new(iso20022.AmountAndDirection46)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddOtherAmounts() *iso20022.OtherAmounts28 {
	s.OtherAmounts = new(iso20022.OtherAmounts28)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstructionV07) AddOtherBusinessParties() *iso20022.OtherParties27 {
...
func (s *SecuritiesSettlementTransactionInstructionV07) AddSupplementaryData() *iso20022.SupplementaryData1 {
