...
func (d *Document02600206) AddMessage() *SecuritiesSettlementTransactionReversalAdvice002V06 {
	d.Message = new(SecuritiesSettlementTransactionReversalAdvice002V06)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification24 {
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddConfirmationReference() *iso20022.Identification16 {
	s.ConfirmationReference = new(iso20022.Identification16)
	return s.ConfirmationReference
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddAdditionalParameters() *iso20022.AdditionalParameters32 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters32)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails62 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails62)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount57 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount57)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSettlementParameters() *iso20022.SettlementDetails134 {
	s.SettlementParameters = new(iso20022.SettlementDetails134)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddStandingSettlementInstructionDetails() *iso20022.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddCashParties() *iso20022.CashParties32 {
	s.CashParties = new(iso20022.CashParties32)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSettledAmount() *iso20022.AmountAndDirection60 {
	s.SettledAmount = new(iso20022.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddOtherAmounts() *iso20022.OtherAmounts38 {
	s.OtherAmounts = new(iso20022.OtherAmounts38)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddOtherBusinessParties() *iso20022.OtherParties29 {
...
func (s *SecuritiesSettlementTransactionReversalAdvice002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
