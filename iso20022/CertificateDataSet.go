...
type CertificateDataSet2 struct {
	...
	// Characteristics of the goods that are certified, in the context of a commercial trade transaction.
	CertifiedCharacteristics *CertifiedCharacteristics2Choice `xml:"CertfdChrtcs"`
...
func (c *CertificateDataSet2) SetCertificateType(value string) {
	c.CertificateType = (*TradeCertificateType1Code)(&value)
}
...
func (c *CertificateDataSet2) AddCertifiedCharacteristics() *CertifiedCharacteristics2Choice {
	c.CertifiedCharacteristics = new(CertifiedCharacteristics2Choice)
	return c.CertifiedCharacteristics
}

func (c *CertificateDataSet2) SetIssueDate(value string) {
	c.IssueDate = (*ISODate)(&value)
}

func (c *CertificateDataSet2) AddPlaceOfIssue() *PostalAddress5 {
	c.PlaceOfIssue = new(PostalAddress5)
	return c.PlaceOfIssue
}

func (c *CertificateDataSet2) AddIssuer() *PartyIdentification26 {
	c.Issuer = new(PartyIdentification26)
	return c.Issuer
}

func (c *CertificateDataSet2) AddInspectionDate() *DatePeriodDetails {
	c.InspectionDate = new(DatePeriodDetails)
	return c.InspectionDate
}

func (c *CertificateDataSet2) SetAuthorisedInspectorIndicator(value string) {
	c.AuthorisedInspectorIndicator = (*YesNoIndicator)(&value)
}

func (c *CertificateDataSet2) SetCertificateIdentification(value string) {
	c.CertificateIdentification = (*Max35Text)(&value)
}

func (c *CertificateDataSet2) AddTransport() *SingleTransport3 {
	c.Transport = new(SingleTransport3)
	return c.Transport
}

func (c *CertificateDataSet2) SetGoodsDescription(value string) {
	c.GoodsDescription = (*Max70Text)(&value)
}

func (c *CertificateDataSet2) AddConsignor() *PartyIdentification26 {
	c.Consignor = new(PartyIdentification26)
	return c.Consignor
}

func (c *CertificateDataSet2) AddConsignee() *PartyIdentification26 {
	c.Consignee = new(PartyIdentification26)
	return c.Consignee
}

func (c *CertificateDataSet2) AddManufacturer() *PartyIdentification26 {
	c.Manufacturer = new(PartyIdentification26)
	return c.Manufacturer
}
