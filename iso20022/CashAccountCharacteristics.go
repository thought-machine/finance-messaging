...
type CashAccountCharacteristics1 struct {
	...
	CashAccount *CashAccount16 `xml:"CshAcct"`
	...
	ParentAccount *ParentCashAccount1 `xml:"PrntAcct,omitempty"`
...
func (c *CashAccountCharacteristics1) SetAccountLevel(value string) {
	c.AccountLevel = (*AccountLevel2Code)(&value)
}

func (c *CashAccountCharacteristics1) AddCashAccount() *CashAccount16 {
	c.CashAccount = new(CashAccount16)
	return c.CashAccount
}

func (c *CashAccountCharacteristics1) AddAccountServicer() *BranchAndFinancialInstitutionIdentification5 {
	c.AccountServicer = new(BranchAndFinancialInstitutionIdentification5)
	return c.AccountServicer
}

func (c *CashAccountCharacteristics1) AddParentAccount() *ParentCashAccount1 {
	c.ParentAccount = new(ParentCashAccount1)
	return c.ParentAccount
}

func (c *CashAccountCharacteristics1) SetCompensationMethod(value string) {
	c.CompensationMethod = (*CompensationMethod1Code)(&value)
}

func (c *CashAccountCharacteristics1) AddDebitAccount() *AccountIdentification4Choice {
	c.DebitAccount = new(AccountIdentification4Choice)
	return c.DebitAccount
}

func (c *CashAccountCharacteristics1) SetDelayedDebitDate(value string) {
	c.DelayedDebitDate = (*ISODate)(&value)
}

func (c *CashAccountCharacteristics1) SetSettlementAdvice(value string) {
	c.SettlementAdvice = (*Max105Text)(&value)
}

func (c *CashAccountCharacteristics1) SetAccountBalanceCurrencyCode(value string) {
	c.AccountBalanceCurrencyCode = (*ActiveOrHistoricCurrencyCode)(&value)
}

func (c *CashAccountCharacteristics1) SetSettlementCurrencyCode(value string) {
	c.SettlementCurrencyCode = (*ActiveOrHistoricCurrencyCode)(&value)
}

func (c *CashAccountCharacteristics1) SetHostCurrencyCode(value string) {
	c.HostCurrencyCode = (*ActiveOrHistoricCurrencyCode)(&value)
}

func (c *CashAccountCharacteristics1) AddTax() *AccountTax1 {
	c.Tax = new(AccountTax1)
	return c.Tax
}

func (c *CashAccountCharacteristics1) AddAccountServicerContact() *ContactDetails3 {
