...
type OtherPrices1 struct {
	...
	ReferencePrice *PriceInformation9 `xml:"RefPric,omitempty"`
}

func (o *OtherPrices1) AddMaximum() *Price4 {
	o.Maximum = new(Price4)
	return o.Maximum
}

func (o *OtherPrices1) AddTransaction() *Price4 {
	o.Transaction = new(Price4)
	return o.Transaction
}

func (o *OtherPrices1) AddMarketBrokerCommission() *Price4 {
	o.MarketBrokerCommission = new(Price4)
	return o.MarketBrokerCommission
}

func (o *OtherPrices1) AddMarkedUp() *Price4 {
	o.MarkedUp = new(Price4)
	return o.MarkedUp
}

func (o *OtherPrices1) AddMarkedDown() *Price4 {
	o.MarkedDown = new(Price4)
	return o.MarkedDown
}

func (o *OtherPrices1) AddNetDisclosed() *Price4 {
	o.NetDisclosed = new(Price4)
	return o.NetDisclosed
}

func (o *OtherPrices1) AddNetUndisclosed() *Price4 {
	o.NetUndisclosed = new(Price4)
	return o.NetUndisclosed
}

func (o *OtherPrices1) AddNotionalGross() *Price4 {
	o.NotionalGross = new(Price4)
	return o.NotionalGross
}

func (o *OtherPrices1) AddBenchmarkWeightedAverage() *Price4 {
	o.BenchmarkWeightedAverage = new(Price4)
	return o.BenchmarkWeightedAverage
}

func (o *OtherPrices1) AddAllMarketsWeightedAverage() *Price4 {
	o.AllMarketsWeightedAverage = new(Price4)
	return o.AllMarketsWeightedAverage
}

func (o *OtherPrices1) AddBenchmark() *Price4 {
	o.Benchmark = new(Price4)
	return o.Benchmark
}

func (o *OtherPrices1) AddOtherPrice() *Price4 {
	o.OtherPrice = new(Price4)
	return o.OtherPrice
}

func (o *OtherPrices1) AddIndexPrice() *Price4 {
	o.IndexPrice = new(Price4)
	return o.IndexPrice
}

func (o *OtherPrices1) AddReportedPrice() *Price4 {
	o.ReportedPrice = new(Price4)
	return o.ReportedPrice
}

func (o *OtherPrices1) AddReferencePrice() *PriceInformation9 {
	o.ReferencePrice = new(PriceInformation9)
