...
func (o *OtherCollateralResponse2) SetResponseType(value string) {
	o.ResponseType = (*Status4Code)(&value)
}

func (o *OtherCollateralResponse2) SetCollateralIdentification(value string) {
	o.CollateralIdentification = (*Max35Text)(&value)
}

func (o *OtherCollateralResponse2) SetAssetNumber(value string) {
	o.AssetNumber = (*Max35Text)(&value)
}

func (o *OtherCollateralResponse2) SetRejectionReason(value string) {
	o.RejectionReason = (*RejectionReasonV021Code)(&value)
}

func (o *OtherCollateralResponse2) SetRejectionInformation(value string) {
	o.RejectionInformation = (*Max35Text)(&value)
}
