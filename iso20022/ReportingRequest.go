...
func (r *ReportingRequest2) SetIdentification(value string) {
	r.Identification = (*Max35Text)(&value)
}

func (r *ReportingRequest2) SetRequestedMessageNameIdentification(value string) {
	r.RequestedMessageNameIdentification = (*Max35Text)(&value)
}

func (r *ReportingRequest2) AddAccount() *CashAccount16 {
	r.Account = new(CashAccount16)
	return r.Account
}

func (r *ReportingRequest2) AddAccountOwner() *Party12Choice {
	r.AccountOwner = new(Party12Choice)
	return r.AccountOwner
}

func (r *ReportingRequest2) AddAccountServicer() *BranchAndFinancialInstitutionIdentification5 {
	r.AccountServicer = new(BranchAndFinancialInstitutionIdentification5)
	return r.AccountServicer
}

func (r *ReportingRequest2) AddReportingPeriod() *ReportingPeriod1 {
	r.ReportingPeriod = new(ReportingPeriod1)
	return r.ReportingPeriod
}

func (r *ReportingRequest2) AddRequestedTransactionType() *TransactionType1 {
	r.RequestedTransactionType = new(TransactionType1)
	return r.RequestedTransactionType
}

func (r *ReportingRequest2) AddRequestedBalanceType() *BalanceType12 {
